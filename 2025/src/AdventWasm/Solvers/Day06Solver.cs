...
{
    public string Title => "Operator Aggregation";
    public string Description => "Aggregate rows/columns using + and * operators from the last row.";
    ...
    private static List<(int start, int end, char operation)> GetRanges(List<List<char>> chars)
    {
