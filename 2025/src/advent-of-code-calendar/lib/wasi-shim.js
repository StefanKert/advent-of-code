      ...
      wasi_snapshot_preview1: {
        ...
        environ_get: (environPtr, environBufPtr) => {
          ...
          try {
            ...
            console.error('environ_get error:', e);
          }
          return 0;
        },
        ...
        fd_fdstat_get: (fd, statPtr) => {
          ...
          try {
            ...
            for (let i = 0; i < 24; i++) {
              view.setUint8(statPtr + i, 0);
            }
            view.setUint8(statPtr, fd <= 2 ? 2 : 4); // fs_filetype: character device or regular file
            view.setUint16(statPtr + 2, 0, true); // fs_flags
            view.setBigUint64(statPtr + 8, BigInt(fd <= 2 ? 0x1fffffff : 0), true); // fs_rights_base
            view.setBigUint64(statPtr + 16, 0n, true); // fs_rights_inheriting
          } catch (e) {
            console.error('fd_fdstat_get error:', e);
          }
          return 0;
        },

        fd_fdstat_set_flags: (fd, flags) => 0,
        fd_prestat_get: (fd, prestatPtr) => 8, // EBADF - no preopened directories
        ...
        clock_time_get: (clockId, precision, timePtr) => {
          ...
          try {
            ...
            console.error('clock_time_get error:', e);
          }
          return 0;
        },
        ...
        clock_res_get: (clockId, resPtr) => {
          ...
          try {
            ...
            console.error('clock_res_get error:', e);
          }
          return 0;
        },
        ...
        args_sizes_get: (argcPtr, argvBufSizePtr) => {
          ...
          try {
            ...
            console.error('args_sizes_get error:', e);
          }
          return 0;
        },
        ...
        // Path operations - all return errors since we don't support filesystem
        path_create_directory: () => 63, // ENOTSUP
        ...
        poll_oneoff: (inPtr, outPtr, nsubscriptions, neventsPtr) => {
          ...
          try {
            ...
            console.error('poll_oneoff error:', e);
          }
          return 0;
        },
        sched_yield: () => 0,
...
export async function runWasiModule(wasmUrl, env = {}) {
  ...
  // Run initialization if available (reactor pattern)
